...
namespace TP_PAV1
{
    public partial class FormEstadistica : Form
    {
        ...
        {
            DataTable tabla = new DataTable();
            tabla = ArticuloXLocal.ObtenerCantidadDeArticulosXLocal();
            ReportDataSource ds = new ReportDataSource("CArticulosXLocal", tabla);
        ...
        {
            DataTable tabla = new DataTable();
            tabla = AD_PlayasYEstacionamientos.ObtenerCantEstacionamientosXPlaya();
